    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MyPurchase.this,MainActivity.class);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                    if (snapshot.hasChildren()){
                        ...
                        Toast.makeText(MyPurchase.this, "No Purchases yet", Toast.LENGTH_SHORT).show();
                    }

                }
                adapter = new PurchaseAdapter(MyPurchase.this,listProduct);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MyPurchase.this, "DATABASE ERROR", Toast.LENGTH_SHORT).show();
            }
        });
